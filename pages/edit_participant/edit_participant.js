...
async function start_me_up(){
    ...
    html.push(place_data("display_details",{size:40}))
    html.push(place_data("home_phone",{size:15}))
    html.push(place_data("mobile_phone",{size:15}))
    html.push(place_data("past_participant",{type:"boolean"}))
    html.push(place_data("years_attended",{type:"integer", size:4}))
    html.push(place_data("sleeping_onsite",{type:"boolean"}))
    html.push(place_data("ready_friday",{type:"boolean"}))
...
function place_data(field,params){
    ...
    if(type==='date'){
        ...
        html.push('type="radio" name="'+field+'" id="'+field+'|yes" onchange="change(this)" value="true"/>Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;')
        html.push('<input ')
        if(!data.fields[field]){
            html.push('checked ')
        }
